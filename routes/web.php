...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::get('/dashboard/{id}/show', [NoteController::class, 'show'])->name('dashboard.show');
    Route::get('/dashboard', [NoteController::class, 'edit'])->name('dashboard.edit');
    Route::post('/dashboard/{note}/update', [NoteController::class, 'update'])->name('dashboard.update');
